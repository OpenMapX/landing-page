...
export const legalConfig = {
  ...
  trademarkEmail: env.PUBLIC_LEGAL_TRADEMARK_EMAIL || 'trademark@openmapx.org',
  hostingProvider: env.PUBLIC_LEGAL_HOSTING_PROVIDER || '',
  hostingLocations: env.PUBLIC_LEGAL_HOSTING_LOCATIONS || '',
